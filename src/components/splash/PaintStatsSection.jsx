...
const stats = [
  { value: 12000, suffix: '+', label: 'Paint Splashes Thrown', color: '#FF007F', icon: '🎨' },
  { value: 98, suffix: '%', label: 'Would Come Back', color: '#39FF14', icon: '🔁' },
  { value: 3500, suffix: '+', label: 'Sessions Completed', color: '#00F3FF', icon: '🖌️' },
  { value: 600, suffix: '+', label: 'Birthday Parties Hosted', color: '#9D00FF', icon: '🎉' },
];
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-heading font-black text-3xl md:text-5xl text-white">
            The Studio <span className="text-neon-pink text-glow-pink">in Numbers</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-20">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div
                className="font-heading font-black text-3xl md:text-4xl mb-2"
                style={{ color: stat.color, textShadow: `0 0 20px ${stat.color}66` }}
              >
                <CountUp target={stat.value} suffix={stat.suffix} />
              </div>
              <p className="font-body text-white/50 text-xs md:text-sm leading-snug">{stat.label}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center">
              ...
              <p className="font-heading font-bold text-white/40 text-xs uppercase tracking-widest mb-2">You Walk In</p>
              <ul className="font-body text-white/30 text-sm space-y-1">
                <li>Stressed from the week</li>
                <li>Clean clothes</li>
                <li>Quiet & unsure</li>
            ...
            <div className="flex-1 text-center">
              ...
              <p className="font-heading font-bold text-neon-pink text-xs uppercase tracking-widest mb-2 text-glow-pink">You Walk Out</p>
              <ul className="font-body text-white/70 text-sm space-y-1">
                <li>Laughing & buzzing</li>
                <li>Covered in neon paint</li>
                <li>New inside joke with your crew</li>
                <li>Already planning your next visit</li>
              </ul>
            </div>
          </div>
        </motion.div>
