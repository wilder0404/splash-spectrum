const dict = {
  en: {
    ...
    why_1_desc: "Seriously. If you can throw paint, you are already an artist here.",
  ...
  ar: {
    ...
    hero_h1_3: '',
    hero_h1_4: 'لا تُنسى',
    hero_sub: 'ارسم. رش. اضحك. اصنع ذكريات تأخذها معك.',
    ...
    why_2_desc: 'رش، اسكب، ارمِ، دع الألوان تسيل. ما في طريقة خاطئة للإبداع.',
    why_3_title: 'لا ضغط',
