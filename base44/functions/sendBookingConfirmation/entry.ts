...
Deno.serve(async (req) => {
  try {
    ...
    // Fetch the booking
    const bookings = await base44.asServiceRole.entities.Booking.list('', 1);
    ...
    // Determine language based on booking or default to English
